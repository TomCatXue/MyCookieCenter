...
- **统一签到 / 权益插件** — `CookieCenter.plugin`，整合微信读书、山西电信与中国电信金豆的凭据捕获与后台定时任务
...
| 文件 | 说明 | 脚本来源 |
|---|---|---|
| [`CookieCenter.plugin`](./CookieCenter.plugin) | 微信读书 / 山西电信 / 电信金豆的凭据捕获 + 后台定时任务 | [`app/weread_claim/`](../app/weread_claim/)、[`plugins/sx_ai_benefit/`](../plugins/sx_ai_benefit/)、[`plugins/telecom_gold/`](../plugins/telecom_gold/) |
