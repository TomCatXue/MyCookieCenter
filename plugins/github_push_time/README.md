...
- 在星标列表每个仓库的星标数/语言行后追加 `· YYYY-MM-DD`，例如 `Python · 2026-08-18`，与网页 `pushed_at` 一致
...
- 显示绝对日期而非相对时间，缓存后不会漂移；网页的“Updated 2小时前”是动态计算的
- 状态：已验证

## 版本历史

- 2026-08-18 v1.0.7 改为绝对日期，与网页 pushed_at 一致，缓存后不再漂移
