...
| 体系 | 目录 | 特点 |
|---|---|---|
| **签到 / 权益体系** | `loon/CookieCenter.plugin`(专用 Cookie 抓取) + `boxjs/`(BoxJS 任务调度与面板) | 脚本位于 `app/weread_claim/`、`plugins/sx_ai_benefit/`、`plugins/telecom_rights/`，需持久化 |
...
> 微信读书与山西电信原先的独立插件已合并进 [`loon/CookieCenter.plugin`](./loon/CookieCenter.plugin)，安装一个插件即可同时获得凭据捕获与后台定时任务；Cookie、偏好等配置在 [`boxjs/CookieCenter.boxjs.json`](./boxjs/CookieCenter.boxjs.json) 面板管理。
